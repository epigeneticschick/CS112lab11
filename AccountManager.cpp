...
void AccountManager::changeUserName(const string& oldUserName, const string& newUserName) {
	...
	if(it != myAccounts.end()){
		...
		try{
			...
			throw Exception("changeUserName(oldUserName,newUserName)", "Could Not change password.");
		}
	}
	else{
		throw Exception("changeUserName(oldUserName,newUserName)","There is no account with that username!");
	}
...
void AccountManager::deleteAccount(const string& userName) {
	if(myAccounts.find(userName) != myAccounts.end()){
		...
		throw Exception("deleteAccount(username)" ,"UserName not found. ");
	}
...
void AccountManager::changePassword(const string& userName,
	...
	if(it != myAccounts.end()){
		...
		throw Exception("changePassword(userName, newPassword)", "UserNAme not found!");
	}
